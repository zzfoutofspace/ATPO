...
class BingSearchTool(BaseTool):
    ...
    def _make_request(self, query: str, timeout: int) -> requests.Response:
        ...
        target_url = f"https://www.google.com/search?{encoded_query}&brd_json=1&cc={self._location}"
    ...
    def execute(self, query: str, timeout: int = 60) -> str:
        ...
        try:
            ...
            response = requests.post("http://127.0.0.1:5003/retrieve", json=payload)
...
if __name__ == "__main__":
    ...
    api_key = "5f91ef3069c39bc459cfdf56ad9c4cd031e8238db5f16dbdecf8da90671c69dc"
    zone = "serp_api_test"
