            ...
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("old_log_prob", timing_raw):
                        ...
                        #save_batch_as_parquet(batch, "/apdcephfs_cq8/share_300190258/espadachen/experiments-output/arpo/saved_batch_with_entropy.parquet")
                    ...
                    if rollout_data_dir:
                        with _timer("dump_rollout_generations", timing_raw):
                            ...
                            #save_batch_as_parquet(batch, "/apdcephfs_cq8/share_300190258/espadachen/experiments-output/arpo/saved_batch_with_entropy_1246row.parquet")
